...
function RVR_NFolds_Sort_Permutation(Subjects_Data_Path, Subjects_Scores, Times, FoldQuantity, ResultantFolder)
...
for i = 1:Times
    ...
    pipeline.(Job_Name).command = 'RVR_NFolds_Sort_Permutation_Sub(opt.para1, opt.para2, '''', opt.para3, ''Scale'', opt.para4)';
    ...
    pipeline.(Job_Name).opt.para4 = ResultantFolder_I;
